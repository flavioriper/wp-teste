...
jQuery(function ($) {
    ...
    jQuery(".wpbe_calculator_value").keydown(function (e) {
        if (e.keyCode == 13)
        {
    ...
    jQuery("#wpbe_calculator").keydown(function (e) {
        if (e.keyCode == 27)
        {
            jQuery('.wpbe_calculator_close').trigger('click');
        }
    ...
    jQuery('.wpbe_calculator_operation').change(function () {
        wpbe_set_to_storage('wpbe_calculator_operation', jQuery(this).val());
        return true;
    });

    jQuery('.wpbe_calculator_how').change(function () {
...
function wpbe_calc_onmouseover_num_textinput(_this, colIndex) {
    ...
    if (jQuery(_this).find('.info_restricked').size() > 0 || jQuery(_this).data('editable-view') !== 'textinput') {
        jQuery('.wpbe_calculator_btn').hide();
        return;
    }
