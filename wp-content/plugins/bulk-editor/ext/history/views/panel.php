...
global $WPBE;
?>
<h4><?php esc_html_e('History', 'bulk-editor') ?> - <a href="https://wp.bulk-editor.com/document/history/" target="_blank" class="button button-primary wpbe-info-btn"><span class="icon-book"></span>&nbsp;<?php esc_html_e('Documentation', 'bulk-editor') ?></a></h4>
