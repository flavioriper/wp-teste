...
jQuery(function ($) {
    ...
    jQuery('.wpbe_meta_delete').life('click', function () {
    ...
    jQuery('.wpbe_meta_key_input').keydown(function (e) {
        if (e.keyCode == 13) {
    ...
    jQuery('.wpbe_meta_keys_get_input').keydown(function (e) {
        if (e.keyCode == 13) {
    ...
    jQuery('.wpbe_meta_view_selector').life('change', function () {
...
function wpbe_act_meta_popup_editor(_this) {
    ...
    jQuery('.wpbe-modal-save10').unbind('click');
    ...
    jQuery('.wpbe-modal-close10').unbind('click');
...
function __wpbe_init_meta_popup_editor() {
    ...
    jQuery('.wpbe_prod_delete').unbind('click');
