...
class GMW_Form_Editor {
			...
			'search_form'       => array(
				...
				'fields'   => array(
					...
					'filter_author'  => array(
                        ...
                        'type'       => 'checkbox',
                        'default'    => '',
                        'label'      => __( 'Display list of results by author', 'geo-my-wp' ),
                        'desc'       => __( 'Check this checkbox to output a list of results by autho on form submission.', 'geo-my-wp' ),
                        'cb_label'   => __( 'Enable', 'geo-my-wp' ),
                        'attributes' => array(),
                        'priority'   => 30,
                    ),
			...
			'search_results'    => array(
				...
				'fields'   => array(
					...
					'carousel_image'  => array(
						...
						'type'       => 'function',
						'default'    => '',
						'label'      => __( 'Carousel Images', 'geo-my-wp' ),
						'desc'       => __( '<p>Check this checkbox to display the image of each location in the list of results, then enter the width and height in pixels ( enter numeric value only, without "px" ).</p>', 'geo-my-wp' ),
						'attributes' => array(),
						'priority'   => 50,
					),
	...
	public function output() {
		...
		add_action( 'gmw_form_settings_carousel_image', array( 'GMW_Form_Settings_Helper', 'carousel_image' ), 10, 2 );
