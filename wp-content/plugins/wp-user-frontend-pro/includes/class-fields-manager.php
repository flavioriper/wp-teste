...
class WPUF_Pro_Fields_Manager {
    ...
    public function register_fields( $fields ) {
        ...
        if ( class_exists( 'WPUF_Field_Contract' ) ) {
            ...
            require_once dirname( __FILE__ ) . '/fields/class-field-time.php';
            ...
            $fields['phone_field']           = new WPUF_Form_Field_Phone();
            $fields['time_field']            = new WPUF_Form_Field_Time();
        }
    ...
    public function add_to_custom_fields( $fields ) {
        $pro_fields = array(
            'repeat_field', 'date_field', 'time_field', 'file_upload', 'country_list_field',
            'numeric_text_field', 'phone_field', 'address_field', 'google_map', 'step_start',
            'embed',
        );
