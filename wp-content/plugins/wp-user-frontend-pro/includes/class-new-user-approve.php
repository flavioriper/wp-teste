...
class WPUF_New_User_Approve {
    ...
    public function add_global_settings( $settings_fields ) {
        ...
        $settings_fields['wpuf_mails'][] = array(
            ...
            'desc'     => __( 'This sets the body of the emails sent to approved users <br><strong>You may use: </strong><code>{login_url}</code><code>{username}</code><code>{user_email}</code><code>{display_name}</code><br><code>{user_status}</code><code>{blog_name}</code>', 'wpuf-pro' ),
            'default'  => 'Hi {username},
