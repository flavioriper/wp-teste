...
class WPUF_Pro_Render_Form {
    ...
    function enqueue_scripts_styles() {
        ...
        if ( has_shortcode( $post->post_content, 'wpuf_form' )
            ...
            || has_shortcode( $post->post_content, 'wpuf_account' )
            || is_single()
            || is_page_template()
            ...
            wp_enqueue_style( 'wpuf-intlTelInput', WPUF_PRO_ROOT_URI . '/includes/libs/intl-tel-input/css/intlTelInput.min.css', [], '17.0.5' );
            ...
            wp_enqueue_script( 'wpuf-intlTelInput', WPUF_PRO_ROOT_URI . '/includes/libs/intl-tel-input/js/intlTelInput.min.js', [ 'jquery' ], '17.0.5', true );
        }
    }
