        ...
        <table class="form-table">
            ...
            <tr class="wpuf_expiration_field">
                ...
                <td>
                    ...
                    <p class="description"><?php _e( 'Status of post after post expiration time is over', 'wpuf-pro' ); ?></p>
            ...
            <tr class="wpuf_expiration_field">
                ...
                <td>
                    ...
                    <p class="description"><strong><?php echo __( 'You may use: {post_author} {post_url} {blogname} {post_title} {post_status}', 'wpuf-pro' ); ?></strong></p>
                </td>
            </tr>
        </table>
    <?php
